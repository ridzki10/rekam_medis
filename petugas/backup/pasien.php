...
<table align="left">
    ...
    <tr>
        ...
        <td><input type="text" name="txtno_pasien" readonly="true" value="<?php echo $f['no_pasien']; ?>" />
		<input type="hidden" name="txtno_pasienx" value="<?php echo $f['no_pasien']; ?>"/></td>
    </tr>
    <tr>
   ...
   <tr>
        ...
        <td><input type="text" name="txtusia" readonly="true" value="<?php echo $f['usia']; ?>" /></td>
    </tr>
    <tr>
