...
switch ($action){
	case 'tambah' :
		...
		$a = "INSERT INTO pasien VALUES ('$no_pasien', '$nm_pasien','$jenis_kelamin','$agama','$alamat','$tgl_lahir',year(now())- year('$tgl_lahir'),'$no_telp','$nm_kk','$hub_kel','$password')";
	...
	$a = "UPDATE pasien SET no_pasien = '$no_pasien',nm_pasien = '$nm_pasien', jenis_kelamin = '$jenis_kelamin',agama ='$agama',alamat = '$alamat',tgl_lahir = '$tgl_lahir',usia = '$usia', no_telp = '$no_telp', nm_kk = '$nm_kk', hub_kel = '$hub_kel', password='$password' WHERE no_pasien = '$no_pasienx'";
	$b = mysql_query($a) or die (mysql_error());
if ($b == true){
