			...
			<div class="span4 login-span">
				...
				<div class="login-wrapper">
					<div class="login-inner">
						...
						<small class="muted">Gunakan User Dokter</small>
						<div class="squiggly-border"></div>

						<div class="login-inner">
							<form class="form-horizontal" action="login_cek.php" method="post" name="form_login" />
								<div class="input-prepend">
									<span class="add-on"> <i class="radmin-icon radmin-user"></i>
									</span>
									<input class="input-large" name="txtuser" id="input-username" size="16" type="text" placeholder="Username" /></div>
								<br />
								<br />
								<div class="input-prepend">
							...
							<input style="margin-top:20px; width:210px" class="btn btn-lg btn-primary btn-block" type="submit" value="Login" />
								<br><a href="depan.html">Kunjungi Website Utama</br>
							</form>
						</div>
