...
switch ($action){
	case 'tambah' :
		...
		$a = "INSERT INTO rekam_medis VALUES ('$no_rm','$tindakan', '$obat', '$dokter','$pasien','$diagnosa','$resep','$keluhan','$tanggal_pemeriksaan','$tanggal_pulang','$keterangan')";
	...
	case 'update' :
		...
		$tanggal_pulang 		= $_POST ['txttgl_pulang'];
		$keterangan 				= $_POST ['txtket'];
	$a = "UPDATE rekam_medis SET no_rm = '$no_rm',kd_tindakan = '$tindakan', kd_obat = '$obat', kd_dokter = '$dokter',no_pasien ='$pasien',diagnosa = '$diagnosa',resep ='$resep',keluhan='$keluhan',tgl_pemeriksaan='$tanggal_pemeriksaan',tgl_kesembuhan='$tanggal_pulang',ket='$keterangan' WHERE no_rm = '$no_rmx'";
	$b = mysql_query($a) or die (mysql_error());
if ($b == true){
