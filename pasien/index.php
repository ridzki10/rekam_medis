...
<head>
	...
	<meta charset="utf-8" />
	<title>Laporan Hasil Rekam Medis</title>
...
<body id="body-index">
	...
	<div class="navbar navbar-inverse navbar-static-top">
		<div class="navbar-inner black-gradient">
			<div class="container-fluid">
				...
				<img src="./img/logo.png" width="112px" height="25px"/>
	...
	<?php if(isset($_SESSION['nm_pasien'])){
		?>
	<div class="row-fluid hidden-phone hidden-tablet">
		<div class="span12 top-stats">
			<ul class="top-nav-boxes">
				...
				<li class="first">
					<a href="index.php">
						<i class="radmin-home"></i>
						<span>Beranda</span>
					</a>
				</li>
				<li>
					<a href="index.php?hal=profil">
						<i class="radmin-user"></i>
						<span>Profile</span>
					</a>
				</li>
				...
				<li>
					<a href="index.php?hal=rekam">
						<i class="radmin-screen"></i>
						<span>Detail Rekam</span>
					</a>
				</li>
				
				<li>
					<a href="index.php?hal=info">
						<i class="radmin-book"></i>
						<span>Info</span>
					</a>
				</li>
